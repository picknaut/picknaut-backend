...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <style type="text/css" rel="stylesheet" media="all">
        @media only screen and (max-width: 600px) { 
            ...
            .content-cell p { font-size: 12px !important }
            .button { font-size: 12px !important; padding: 10px 14px !important }
            .sub { font-size: 8px !important }
        }
        @media only screen and (min-width: 601px) and (max-width: 1024px) {
            .content-cell p { font-size: 16px !important }
            .button { font-size: 16px !important; padding: 12px 18px !important }
            .sub { font-size: 12px !important }
        }
        @media only screen and (min-width: 1025px) {
            .content-cell p { font-size: 18px !important }
            .button { font-size: 18px !important; padding: 14px 20px !important }
            .sub { font-size: 14px !important }
        }
        .button:hover { background-color: #784464 !important; color: #FFFFFF !important; border-color: #784464 !important }
        .button--green:hover { background-color: #22BC66 !important }
        .button--red:hover { background-color: #FF6136 !important }
    </style>
  </head>
                        ...
                        <!-- Email Body -->
                                ...
                                <td class="email-body" width="100%" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; width: 100%; margin: 0; padding: 0; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; border-bottom: 1px solid #EDEFF2; background-color: #FFFFFF;">
                                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; width: 570px; margin: 0 auto; padding: 0; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; background-color: #FFFFFF;">
                                            <!-- Body content -->
                                            <tbody style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box;"><tr>
                                            <td class="content-cell" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                            <p style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; text-align: left; color: #000000; font-size: 16px; margin-top: 0; margin-bottom: 15px;">Hi there,</p>

                                                    <p style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; text-align: left; color: #000000; font-size: 16px; margin-top: 0; margin-bottom: 15px;">Thanks for subscribing to Picknaut - We're very excited to have you onboard!</p>

                                                    <p class="center" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; text-align: center; color: #000000; font-size: 16px; margin-top: 0; margin-bottom: 15px;">
                                                        <a class="button" href="https://www.picknaut.com" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; color: #000000; font-weight: 500; background-color: #FFFFFF; border: 2px solid #000000; display: inline-block; padding: 12px 18px; text-decoration: none; border-radius: 0; -webkit-text-size-adjust: none; margin-top: 5px; margin-bottom: 10px;">Explore Now ›</a>
                                                    </p>

                                                    <p style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; text-align: left; color: #000000; font-size: 16px; margin-top: 0; margin-bottom: 15px;">From tech tools and lifestyle hacks to finance tips and smart updates, we'll be dropping our best ideas straight into your inbox.</p>

                                                    <p style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1.5em; text-align: left; color: #000000; font-size: 16px; margin-top: 0; margin-bottom: 15px;">Keep an eye out for our next update. Until then — explore, learn, and stay curious!</p>
                                                    ...
                                                    <table width="100%" class="body-sub" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; margin-top: 25px; padding-top: 25px; border-top: 1px solid #EDEFF2;">
                                                        <tbody style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box;"><tr>
                                                        <td class="content-cell" align="center" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                                                            <p class="sub align-center" style="font-family: 'Helvetica Neue', Arial, Helvetica, sans-serif; box-sizing: border-box; line-height: 1; text-align: center; color: #000000; font-size: 12px; margin-top: 0; margin-bottom: 15px;">© 2025 Picknaut</p>                                                        
                                                        </td>
                                                        </tr>
                                                    </tbody></table>
                                                    </td>
  ...
  await subscribeTransporter.sendMail({
    from: `"Picknaut" <${process.env.SUBSCRIBE_USER}>`,
    to: toEmail,
